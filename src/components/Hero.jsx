    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 h-full flex flex-col justify-center items-center text-center gap-20 pt-20">
                ...
                <button
                    onClick={prevSlide}
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-10 rounded-full p-2 hover:bg-white transition-colors duration-300"
                >
                    <i
                        className="icone fa-solid fa-arrow-left text-inherit"
                        style={{ color: "white" }}
                    ></i>
                </button>
                <button
                    onClick={nextSlide}
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-10 rounded-full p-2 hover:bg-white transition-colors duration-300"
                >
